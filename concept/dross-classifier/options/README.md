...
**The sheets are at `concept/dross-classifier/options/`.**
...
`concept/dross-classifier/five-options-contact-sheet.png`, which
holds all five at reduced size so the comparison can still be seen.

The adopted sheet is `concept/dross-classifier/adopted/A-sheet.png`.
