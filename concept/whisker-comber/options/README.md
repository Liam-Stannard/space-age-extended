...
**The sheets are at `concept/whisker-comber/options/`.**
...
`concept/whisker-comber/five-options-contact-sheet.png`, which
holds all five at reduced size so the comparison can still be seen.

The adopted sheet is `concept/whisker-comber/adopted/C-sheet.png`.
