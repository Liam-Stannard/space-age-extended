...
> is locked at `concept/whisker-comber/options/C-sheet.png`. Every other option in this directory is
...
`concept/whisker-comber/options/C-sheet.png`, generated 2026-09-08 from the prompt above with the four attachments named
in the README.
