...
> is locked at `concept/coil-separator/options/D-sheet.png`. Every other option in this directory is
...
`concept/coil-separator/options/D-sheet.png`, generated 2026-09-08 from the prompt above with the four attachments named
in the README.
