...
**The sheets are at `concept/coil-separator/options/`.**
...
`concept/coil-separator/five-options-contact-sheet.png`, which
holds all five at reduced size so the comparison can still be seen.

The adopted sheet is `concept/coil-separator/adopted/D-sheet.png`.
