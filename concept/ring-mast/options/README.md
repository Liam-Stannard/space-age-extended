...
**Note the exception.** the art backlog (now `TODO.md`) warns that the format example is the
...
All five sheets are in `concept/ring-mast/options/`. Read them
...
Locked 2026-09-10. The sheet is `concept/ring-mast/adopted/A-sheet.png`;
