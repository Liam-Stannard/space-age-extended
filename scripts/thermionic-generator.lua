...
--
-- Architecture (Phase 4 spike, see PROGRESS.md): a visible
...
-- with a hidden 2-slot `container` (`sae-thermionic-generator-hopper`)
-- that holds the Magmatic Core / Ice inputs. The pair is linked both
-- directions in `storage`, keyed by `unit_number`.
--
