...
magnetic separator standing on an airless metallic world. Its centre is a thick
copper-brown toroidal coil mounted vertically with an open aperture facing the
viewer; a stream of grey ore passes through the opening and divides into two
angled chutes below. Heavy flat pale-grey bus bars enter the coil from both
flanks. Cooling fins on the coil's outer face. A steady cold blue-violet glow
...
smoke, no flame. Panels: main view, front elevation, side elevation, a detail of
the coil throat and the splitter chutes, and a lit/unlit pair.
```
