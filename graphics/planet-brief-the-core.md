...
icon (see [icon-sheet-prompts.md](icon-sheet-prompts.md)) nor a building plate
(see [building-spec-template.md](building-spec-template.md)), so it gets its own
short brief.
...
[building-spec-template.md](building-spec-template.md) Appendix C.
